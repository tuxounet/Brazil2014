var PageTransitions = (function () {
    ...
    function nextPage(loadOperation, animation, callback) {
        ...
        if (boot.isLegacy) {
            ...
            onEndAnimation($currPage, $nextPage, loadOperation, callback);
        } else {
    ...
    function onEndAnimation($outpage, $inpage, loadOperation, callback) {
        endCurrPage = false;
        endNextPage = false;
        ...
        if (loadOperation) loadOperation();
    ...
    function slidePage($targetPage, animation, loadOperation, callback) {

        //Si il n'y a pas de page courante
        if ($("#pt-main .pt-page").length == 0) {



            setPage($targetPage, loadOperation, callback);
        }
        else {
            ...
            nextPage(loadOperation, animation, callback);
        }

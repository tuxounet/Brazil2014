var WebSQLProviderInitClass = function () {
    ...
    self.performInit = function (db, successCB, errorCB) {
        ...
        db.transaction(function (tx) {
            ...
            tx.executeSql("CREATE TABLE IF NOT EXISTS Match(ID INTEGER unique, Date DATETIME, Hour TIME, IdFIFA TEXT, IsExtraTime INT2, MatchTime TIME, MatchType INTEGER,  MatchTypeName TEXT,  MatchGroup TEXT, Rank INTEGER, Stade INTEGER, StadeName TEXT, Team1 INTEGER, Team1Name TEXT,Team1IdFIFA TEXT, Team1Goal INTEGER, Team1GoalsBy TEXT, Team1Penalty INTEGER, Team2 INTEGER, Team2Name TEXT,Team2IdFIFA TEXT, Team2Goal INTEGER, Team2GoalsBy TEXT, Team2Penalty INTEGER, Broadcaster INTEGER);")
            tx.executeSql("CREATE TABLE IF NOT EXISTS Video(ID INTEGER unique, Date DATETIME, Title TEXT, VideoLink TEXT, IdFIFA TEXT, ThumbLink TEXT);")
            tx.executeSql("CREATE TABLE IF NOT EXISTS News(ID TEXT unique, Date DATETIME, Title TEXT, Summary TEXT, Content TEXT, IdFIFA TEXT, ThumbUrl TEXT);")
